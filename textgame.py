...
# I made a class that asks the player for their name
class Name(object):
    def __init__(self, name):
        self.name = name

# This string will ask the player for their name and recieve the name as the input. The ".title()" capitalizes the name in the following string.
name = Name(input("What is your name? ").title())
...
# "{name.name}" refers to the class. When played in the bash console, the string will include the name entered as an input.
# The "f" in front of the quotations allows for the class variable to be printed.
type_out(f"""Welcome to Strangers Things: The Text Based Game, {name.name}.
